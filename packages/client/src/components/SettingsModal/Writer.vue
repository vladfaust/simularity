...
.flex.flex-col.gap-2.p-3
  .flex.gap-2.rounded-b-lg.rounded-tr-lg.border.p-2
    ...
    p.text-sm.leading-tight Writer agent is responsible, among other tasks, for generating the story. It has to be a capable model trained for roleplay. Bigger context size allows to go on with the story for longer without the need to consolidate.
