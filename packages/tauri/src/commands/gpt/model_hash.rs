...
pub async fn gpt_model_hash_by_id(model_id: String) -> Result<Response, tauri::InvokeError> {
...
#[tauri::command]
/// Get the hash of a model with the given ID.
pub async fn gpt_model_hash_by_path(model_path: String) -> Result<Response, tauri::InvokeError> {
